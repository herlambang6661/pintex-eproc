                            ...
                            <div class="card card-sm">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-3">
                                            <iframe src="https://lottie.host/embed/97ec1b9d-a3a0-49a5-ad64-fde41649f07e/AO6UokX4rf.lottie" width="300px" height="300px"></iframe>
                                        </div>
                                        <div class="col-9">
                                            <h3 class="h1">Selamat Datang di E-PROCUREMENT, {{ Auth::user()->name }} 🎉</h3>
                                            <div class="markdown text-secondary">
                                                Aplikasi E-PROC ini adalah aplikasi untuk pengadaan barang di PT. Plumbon International Textile.
                                                <br>
