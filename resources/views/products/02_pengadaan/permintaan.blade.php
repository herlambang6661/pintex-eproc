            ...
            $(function () {
                ...
                --------------------------------------------*/
                    var table = $('.datatable-permintaan').DataTable({
                        ...
                        columns: [
                            {data: 'DT_RowIndex', name: 'DT_RowIndex', className: "cuspad0 cuspad1"},
                            {data: 'kodeseri', name: 'kodeseri', className: "cuspad0 cuspad1 text-center"},
                            {data: 'namaBarang', name: 'namaBarang', className: "cuspad0 cuspad1"},
                            {data: 'tgl', name: 'tgl', className: "cuspad0 text-center"},
                            {data: 'noform', name: 'noform', className: "cuspad0 cuspad1 text-center"},
                            {data: 'keterangan', name: 'keterangan', className: "cuspad0 cuspad1"},
                            {data: 'katalog', name: 'katalog', className: "cuspad0 cuspad1"},
                            {data: 'part', name: 'part', className: "cuspad0 cuspad1"},
                            {data: 'mesinV', name: 'mesinV', className: "cuspad0 cuspad1 text-center"},
                            {data: 'qty', name: 'qty', className: "cuspad0 cuspad1 text-center"},
                            {data: 'qtyacc', name: 'qtyacc', className: "cuspad0 text-center"},
                            {data: 'dibeli', name: 'dibeli', className: "cuspad0 cuspad1 text-center"},
                            {data: 'stt', name: 'stt', className: 'text-center cuspad0 text-center'},
