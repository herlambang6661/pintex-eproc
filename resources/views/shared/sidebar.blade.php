                ...
                @if (Auth::user()->p_teknik === 1)
                    <li
                        ...
                        <div
                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    @if (Auth::user()->c_servis === 1)
                                        <a class="dropdown-item" href="{{ url('teknik/servis') }}"
                                            {{ $active == 'Servis' ? 'active' : '' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px"
                                                class="icon icon-tabler icon-tabler-home-cog" width="24"
                                                height="24" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                @if (Auth::user()->p_laporan === 1)
                    <li
                        ...
                        <div
                            ...
                            @if (Auth::user()->c_lap_pemakaian === 1)
                            ...
                            @endif
                            @if (Auth::user()->c_lap_pembelian === 1)
                                <a class="dropdown-item" href="{{ url('laporan/pembelian') }}"
                                    {{ $active == 'LaporanPembelian' ? 'active' : '' }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px"
                                        class="icon icon-tabler icon-tabler-clipboard-data" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path
